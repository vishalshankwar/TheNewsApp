...
import com.example.thenewsapp.util.Constants.Companion.SEARCH_NEWS_DELAY
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    lateinit var itemSearchEorr:CardView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        itemSearchEorr=view.findViewById(R.id.itemSearchError)
    ...
    private fun hideErrorMessage(){
        itemSearchEorr.visibility=View.INVISIBLE
        isError=false
    }
    private fun showErrorMeassage(message: String){
        itemSearchEorr.visibility=View.VISIBLE
